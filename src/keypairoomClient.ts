...
# and the hashes OPTIONALLY stored by the server, to improve regeneration of the keyring
...
# Creating the keyring from the hash just created
#When I create the keyring with secret key 'concatenatedHashes'

# Here we are setting the seed for the random to 'concatenatedHashes' we just created
When I seed the random with 'concatenatedHashes'

# Here we are creating SKs and PKs
...
Then print the 'concatenatedHashes' as 'mnemonic'
`}
